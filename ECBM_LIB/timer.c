...
void timer_init(void){
    #if (ECBM_TIMER0_EN)
        TIMER0_SET_REG_AUXR (ECBM_TIMER0_AUXR);
        TIMER0_SET_REG_TMOD (ECBM_TIMER0_TMOD);
        TIMER0_SET_REG_HL   (65536-ECBM_TIMER0_COUNT);
        #if (ECBM_TIMER0_IT_EN)
            TIMER0_IT_ENABLE;
        #endif
    ...
    #if (ECBM_TIMER1_EN)
        TIMER1_SET_REG_AUXR (ECBM_TIMER1_AUXR);
        TIMER1_SET_REG_TMOD (ECBM_TIMER1_TMOD);
        TIMER1_SET_REG_HL   (65536-ECBM_TIMER1_COUNT);
        #if (ECBM_TIMER1_IT_EN)
            TIMER1_IT_ENABLE;
        #endif
    ...
    #if (ECBM_TIMER2_EN)
        TIMER2_SET_REG_AUXR (ECBM_TIMER2_AUXR);
        TIMER2_SET_REG_HL   (65536-ECBM_TIMER2_COUNT);
        #if (ECBM_TIMER2_IT_EN)
            TIMER2_IT_ENABLE;
        #endif
    ...
    #if (ECBM_TIMER3_EN)
        TIMER3_SET_REG_T4T3M    (ECBM_TIMER3_T4T3M);
        TIMER3_SET_REG_HL       (65536-ECBM_TIMER3_COUNT);
        #if (ECBM_TIMER3_IT_EN)
            TIMER3_IT_ENABLE;
        #endif
    ...
    #if (ECBM_TIMER4_EN)
        TIMER4_SET_REG_T4T3M    (ECBM_TIMER4_T4T3M);
        TIMER4_SET_REG_HL       (65536-ECBM_TIMER4_COUNT);
        #if (ECBM_TIMER4_IT_EN)
            TIMER4_IT_ENABLE;
        #endif
